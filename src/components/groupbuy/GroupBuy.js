...
const CAMPAIGN_METADATA = {
    0: { name: "[GB] SHA-7 Mechanical Keyboard", image: "/keyboard.png" },
    1: { name: "[GB] Hydro Flask Water Bottle", image: "/water_bottle.png" },
    2: { name: "[GB] Custom Phone Case", image: "/phone_case.png" },
};
...
export default function GroupBuy() {
    ...
    const handleRefundClick = async () => {
        if (!contract || !address || !userHasCommitted || userHasRefunded || status !== 'Cancelled') return;
        setErrorMessage("");
        setIsRefunding(true);
        try {
                ...
                <div className="groupbuy-content">
                    ...
                    {status === 'Cancelled' && (userHasCommitted ? (userHasRefunded ? (
                        ...
                        <div className="refund-section">
                            ...
                            <button className="commit-button cancel" onClick={handleRefundClick} disabled={isRefunding}>
